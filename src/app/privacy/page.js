export const metadata = {
  title: "Privacy Policy | Cicada Music Society",
  description: "Privacy Policy for Cicada Music Society",
};
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-neutral-300 py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-neutral-400 mb-8">Last updated: January 20, 2026</p>
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-neutral-300 leading-relaxed">
              Welcome to Cicada Music Society ("we," "our," or "us"). We are
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-neutral-300 ml-4">
              ...
              <li>
                <strong>Payment Information:</strong> When you purchase tickets,
                payment processing is handled securely by Stripe. We do not
                store your full credit card details.
              </li>
              <li>
                <strong>Transaction Information:</strong> Details about tickets
                purchased, event attendance, and order history.
              </li>
              <li>
                <strong>Communications:</strong> Information you provide when
                contacting us or responding to surveys.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-neutral-800 rounded-lg">
              <p className="text-neutral-300">Cicada Music Society</p>
              <p className="text-neutral-300">
                Email:{" "}
                <a
                  href="mailto:contact@cicadamusic.com"
                  className="text-indigo-400 hover:text-indigo-300"
                >
                  contact@cicadamusic.com
                </a>
              </p>
              <p className="text-neutral-300">
                Instagram:{" "}
